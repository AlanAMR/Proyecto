...
<head>
    ...
    <title>Code Pro - Ingresar</title>

    <!-- Custom fonts for this template-->
    <link href="{{asset('admin_theme/vendor/fontawesome-free/css/all.css')}}" rel="stylesheet" type="text/css">
    <link
        href="{{asset('admin_theme/css/nunito.css')}}"
        rel="stylesheet">

    <!-- Custom styles for this template-->
    <link href="{{asset('admin_theme/css/sb-admin-2.css')}}" rel="stylesheet">
                                    ...
                                    <form class="user" method="POST" action="{{ route('login') }}">
                                        ...
                                        @error('email')
                                            <div class="alert alert-danger" role="alert">
                                              <li>Comprueba tu direccion de correo o usuario.</li>
                                            </div>
                                        @enderror

                                        @error('password')
                                            <div class="alert alert-danger" role="alert">
                                              Las credenciales no coinciden con ningun registro.
                                            </div>
                                        @enderror
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                                ...
                                                placeholder="Email o Usuario" value="{{ old('email') }}" name="email">
                                        </div>
