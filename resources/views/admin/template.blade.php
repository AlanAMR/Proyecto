...
<head>
    ...
    <link
        href="{{asset('admin_theme/css/nunito.css')}}"
        rel="stylesheet">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseAlmacen-ve"
                    aria-expanded="true" aria-controls="collapseAlmacen-ve">
                    <i class="fas fa-fw fa-car"></i>
                    <span>Almacen Vehicular</span>
                </a>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseAlmacen-ge"
                    aria-expanded="true" aria-controls="collapseAlmacen-ge">
            ...
            <!-- Nav Item - seccion para la gestion de usuarios  -->
            <li class="nav-item">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="{{asset('/Imagen_Corporativa/inicio de sesion.jpg')}}">
                            </a>
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Seleccione "Salir" para finalizar la sesion.</div>
