...
<form id="actualizar-ras" method="post" action="{{url('sistemas/conexiones/ras/actualizar')}}">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <select name="tipo" class="form-control" required="">
                    <option value="{{$conexion->tipo}}">{{$conexion->tipo}}</option>
...
<div class="row">
    <div class="col-md-12" style="text-align: center;">
        ...
        <button class="btn btn-info" onclick="document.getElementById('actualizar-ras').submit();">
