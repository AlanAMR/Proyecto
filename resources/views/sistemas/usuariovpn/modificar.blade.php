...
@section('title_right')
<!-- Boton aniadir -->
<a href="{{url('sistemas/accesos/vpn')}}">
...
<form id="modificar-vpn" method="post" action="{{url('sistemas/accesos/vpn/actualizar')}}">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="form-group">
                <label for="contrasenia_confirmacion" class="form-label">Confirmacion de Contvpneña</label>
...
<div class="row">
    <div class="col-md-12" style="text-align: center;">
        ...
        <button class="btn btn-info" onclick="document.getElementById('modificar-vpn').submit();">
