...
<form id="create-servidor" method="post" action="{{url('sistemas/servidores/crear')}}">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" name="procesador" class="form-control" placeholder="Procesador... " value="{{old('procesador')}}" required="">
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" name="ram" class="form-control" placeholder="Memoria Ram... " value="{{old('ram')}}" required="">
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" name="almacenamiento" class="form-control" placeholder="Almacenamiento... " value="{{old('almacenamiento')}}" required="">
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" name="sistema_operativo" class="form-control" placeholder="Sistema Operativo... " value="{{old('sistema_operativo')}}" required="">
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" name="antivirus" class="form-control" placeholder="Antivirus... " value="{{old('antivirus')}}" required="">
            </div>
        </div>
...
<div class="row">
    <div class="col-md-12" style="text-align: center;">
        ...
        <button class="btn btn-info" onclick="document.getElementById('create-servidor').submit();">
            Añadir Servidor
        </button>
    </div>
</div>
