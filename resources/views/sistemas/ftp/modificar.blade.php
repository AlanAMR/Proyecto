...
<form id="actualizar-ftp" method="post" action="{{url('sistemas/conexiones/ftp/actualizar')}}">
...
<div class="row">
    <div class="col-md-12" style="text-align: center;">
        ...
        <button class="btn btn-info" onclick="document.getElementById('actualizar-ftp').submit();">
            Actualizar conexion FTP
        </button>
    </div>
</div>
