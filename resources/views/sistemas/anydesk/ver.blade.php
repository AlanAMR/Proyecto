    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <b>Any Desk: </b> {{$password->anydesk}}<br>
                <br>
                <button class="btn btn-secondary btn-sm" style="margin-right: 5px" onclick="mostrar('{{$password->anydesk}}','{{$password->password}}');"> Mostrar contraseña <i class="far fa-eye"></i></button> 
