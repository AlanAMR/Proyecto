...
<link rel="stylesheet" href="{{asset('plantillas/template11/css/bootstrap.css')}}">
<link rel="stylesheet" href="{{asset('plantillas/template11/css/bootstrap-responsive.css')}}">
<link rel="stylesheet" href="{{asset('plantillas/template11/css/prettyPhoto.css')}}" />
<link rel="stylesheet" href="{{asset('plantillas/template11/css/flexslider.css')}}" />
<link rel="stylesheet" href="{{asset('plantillas/template11/css/custom-styles.css')}}">
...
<!-- Favicons
================================================== -->
<link rel="shortcut icon" href="{{asset('plantillas/template11/img/favicon.ico')}}">
...
<script src="{{asset('plantillas/template11/js/bootstrap.js')}}"></script>
<script src="{{asset('plantillas/template11/js/jquery.prettyPhoto.js')}}"></script>
<script src="{{asset('plantillas/template11/js/jquery.flexslider.js')}}"></script>
<script src="{{asset('plantillas/template11/js/jquery.custom.js')}}"></script>
    ...
    <div class="container">
      ...
      <div class="row header"><!-- Begin Header -->
        ...
        <div class="span5 logo">
        	<a href="index.htm"><img src="{{asset('plantillas/template11/img/piccolo-logo.png')}}" alt="" /></a>
    ...
    <div class="row headline"><!-- Begin Headline -->
        ...
        <div class="span8">
            <div class="flexslider">
              <ul class="slides">
                <li><a href="gallery-single.htm"><img src="{{asset('plantillas/template11/img/gallery/slider-img-1.jpg')}}" alt="slider" /></a></li>
                <li><a href="gallery-single.htm"><img src="{{asset('plantillas/template11/img/gallery/slider-img-2.jpg')}}" alt="slider" /></a></li>
                <li><a href="gallery-single.htm"><img src="{{asset('plantillas/template11/img/gallery/slider-img-3.jpg')}}" alt="slider" /></a></li>
                <li><a href="gallery-single.htm"><img src="{{asset('plantillas/template11/img/gallery/slider-img-4.jpg')}}" alt="slider" /></a></li>
                <li><a href="gallery-single.htm"><img src="{{asset('plantillas/template11/img/gallery/slider-img-5.jpg')}}" alt="slider" /></a></li>
              </ul>
            </div>
        </div>
        ...
        ================================================== -->
            ...
            <ul class="gallery-post-grid holder">
                    ...
                    <li  class="span3 gallery-item" data-id="id-1" data-type="illustration">
                        ...
                        <a href="gallery-single.htm"><img src="{{asset('plantillas/template11/img/gallery/gallery-img-1-4col.jpg')}}" alt="Gallery"></a>
                    ...
                    <li class="span3 gallery-item" data-id="id-2" data-type="illustration">
                        ...
                        <a href="gallery-single.htm"><img src="{{asset('plantillas/template11/img/gallery/gallery-img-2-4col.jpg')}}" alt="Gallery"></a>
                    ...
                    <li class="span3 gallery-item" data-id="id-3" data-type="web">
                        ...
                        <a href="gallery-single.htm"><img src="{{asset('plantillas/template11/img/gallery/gallery-img-3-4col.jpg')}}" alt="Gallery"></a>
                    ...
                    <li class="span3 gallery-item" data-id="id-4" data-type="video">
                        ...
                        <a href="gallery-single.htm"><img src="{{asset('plantillas/template11/img/gallery/gallery-img-4-4col.jpg')}}" alt="Gallery"></a>
                    ...
                    <li class="span3 gallery-item" data-id="id-5" data-type="web illustration">
                        ...
                        <a href="gallery-single.htm"><img src="{{asset('plantillas/template11/img/gallery/gallery-img-5-4col.jpg')}}" alt="Gallery"></a>
                    ...
                    <li class="span3 gallery-item" data-id="id-6" data-type="illustration design">
                        ...
                        <a href="gallery-single.htm"><img src="{{asset('plantillas/template11/img/gallery/gallery-img-6-4col.jpg')}}" alt="Gallery"></a>
                    ...
                    <li class="span3 gallery-item" data-id="id-7" data-type="design">
                        ...
                        <a href="gallery-single.htm"><img src="{{asset('plantillas/template11/img/gallery/gallery-img-7-4col.jpg')}}" alt="Gallery"></a>
                    ...
                    <li class="span3 gallery-item" data-id="id-8" data-type="web video">
                        ...
                        <a href="gallery-single.htm"><img src="{{asset('plantillas/template11/img/gallery/gallery-img-8-4col.jpg')}}" alt="Gallery"></a>
                    ...
                    <li class="span3 gallery-item" data-id="id-9" data-type="design">
                        ...
                        <a href="gallery-single.htm"><img src="{{asset('plantillas/template11/img/gallery/gallery-img-9-4col.jpg')}}" alt="Gallery"></a>
                    ...
                    <li class="span3 gallery-item" data-id="id-10" data-type="web design">
                        ...
                        <a href="gallery-single.htm"><img src="{{asset('plantillas/template11/img/gallery/gallery-img-10-4col.jpg')}}" alt="Gallery"></a>
                    ...
                    <li class="span3 gallery-item" data-id="id-11" data-type="illustration">
                        ...
                        <a href="gallery-single.htm"><img src="{{asset('plantillas/template11/img/gallery/gallery-img-11-4col.jpg')}}" alt="Gallery"></a>
                    ...
                    <li class="span3 gallery-item" data-id="id-12" data-type="illustration video">
                        ...
                        <a href="gallery-single.htm"><img src="{{asset('plantillas/template11/img/gallery/gallery-img-12-4col.jpg')}}" alt="Gallery"></a>
    ...
    <div class="row"><!-- Begin Bottom Section -->
        ...
        <div id="blogCarousel" class="carousel slide ">
            ...
            <div class="carousel-inner">
                ...
                <div class="active item">
                    <a href="blog-single.htm"><img src="{{asset('plantillas/template11/img/gallery/blog-med-img-1.jpg')}}" alt="" class="align-left blog-thumb-preview" /></a>
                ...
                <!-- Blog Item 2 -->
                 <div class="item">
                    <a href="blog-single.htm"><img src="{{asset('plantillas/template11/img/gallery/blog-med-img-2.jpg')}}" alt="" class="align-left blog-thumb-preview" /></a>
                    <div class="post-info clearfix">
                 ...
                 <!-- Blog Item 3 -->
                 <div class="item">
                    <a href="blog-single.htm"><img src="{{asset('plantillas/template11/img/gallery/blog-med-img-3.jpg')}}" alt="" class="align-left blog-thumb-preview" /></a>
                    <div class="post-info clearfix">
        ...
        <div class="span6">
            ...
            <ul class="client-logos">
                <li><a href="#" class="client-link"><img src="{{asset('plantillas/template11/img/gallery/client-img-1.png')}}" alt="Client"></a></li>
                <li><a href="#" class="client-link"><img src="{{asset('plantillas/template11/img/gallery/client-img-2.png')}}" alt="Client"></a></li>
                <li><a href="#" class="client-link"><img src="{{asset('plantillas/template11/img/gallery/client-img-3.png')}}" alt="Client"></a></li>
                <li><a href="#" class="client-link"><img src="{{asset('plantillas/template11/img/gallery/client-img-4.png')}}" alt="Client"></a></li>
                <li><a href="#" class="client-link"><img src="{{asset('plantillas/template11/img/gallery/client-img-5.png')}}" alt="Client"></a></li>
            </ul>
    	...
    	<div class="container">
        	<div class="row footer-row">
                <div class="span3 footer-col">
                    <h5>About Us</h5>
                   <img src="{{asset('plantillas/template11/img/piccolo-footer-logo.png')}}" alt="Piccolo" /><br /><br />
                    <address>
                ...
                <div class="span3 footer-col">
                    <h5>Flickr Photos</h5>
                    <ul class="img-feed">
                        <li><a href="#"><img src="{{asset('plantillas/template11/img/gallery/flickr-img-1.jpg')}}" alt="Image Feed"></a></li>
                        <li><a href="#"><img src="{{asset('plantillas/template11/img/gallery/flickr-img-2.jpg')}}" alt="Image Feed"></a></li>
                        <li><a href="#"><img src="{{asset('plantillas/template11/img/gallery/flickr-img-3.jpg')}}" alt="Image Feed"></a></li>
                        <li><a href="#"><img src="{{asset('plantillas/template11/img/gallery/flickr-img-4.jpg')}}" alt="Image Feed"></a></li>
                        <li><a href="#"><img src="{{asset('plantillas/template11/img/gallery/flickr-img-5.jpg')}}" alt="Image Feed"></a></li>
                        <li><a href="#"><img src="{{asset('plantillas/template11/img/gallery/flickr-img-6.jpg')}}" alt="Image Feed"></a></li>
                        <li><a href="#"><img src="{{asset('plantillas/template11/img/gallery/flickr-img-7.jpg')}}" alt="Image Feed"></a></li>
                        <li><a href="#"><img src="{{asset('plantillas/template11/img/gallery/flickr-img-8.jpg')}}" alt="Image Feed"></a></li>
                        <li><a href="#"><img src="{{asset('plantillas/template11/img/gallery/flickr-img-9.jpg')}}" alt="Image Feed"></a></li>
                        <li><a href="#"><img src="{{asset('plantillas/template11/img/gallery/flickr-img-10.jpg')}}" alt="Image Feed"></a></li>
                        <li><a href="#"><img src="{{asset('plantillas/template11/img/gallery/flickr-img-11.jpg')}}" alt="Image Feed"></a></li>
                        <li><a href="#"><img src="{{asset('plantillas/template11/img/gallery/flickr-img-12.jpg')}}" alt="Image Feed"></a></li>
                    </ul>
                </div>
            </div>
