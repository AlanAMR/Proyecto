...
<nav class="navbar navbar-expand-lg navbar-light navbar-floating">
  <div class="container">
    <a class="navbar-brand" href="#">
      <img src="{{asset('plantillas/template1/assets/favicon.png')}}" alt="" width="40">
    </a>
      ...
      <ul class="navbar-nav ml-lg-5 mt-3 mt-lg-0">
        <li class="nav-item dropdown active">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            <a class="dropdown-item active" href="../plantilla1">Homepage 1</a>
            <a class="dropdown-item" href="index2">Homepage 2</a>
          </div>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="plantilla1/acercade">About</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="plantilla1/novedades">What's New</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="plantilla1/contacto">Contact</a>
        </li>
      </ul>
    </div>
  </div>
...
<div class="page-hero-section bg-image hero-home-1" style="background-image: url({{asset('plantillas/template1/assets/img/bg_hero_1.svg')}});">
      ...
      <div class="row align-items-center h-100">
        ...
        <div class="col-lg-6 d-none d-lg-block wow zoomIn">
          <div class="img-place mobile-preview shadow floating-animate">
            <img src="{{asset('plantillas/template1/assets/img/app_preview_1.png')}}" alt="">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-sm-6 col-lg-3 py-3 wow zoomIn">
        <div class="img-place client-img">
          <img src="{{asset('plantillas/template1/assets/img/clients/alter_sport.png')}}" alt="">
        </div>
      </div>
      <div class="col-sm-6 col-lg-3 py-3 wow zoomIn">
        <div class="img-place client-img">
          <img src="{{asset('plantillas/template1/assets/img/clients/cleaning_service.png')}}" alt="">
        </div>
      </div>
      <div class="col-sm-6 col-lg-3 py-3 wow zoomIn">
        <div class="img-place client-img">
          <img src="{{asset('plantillas/template1/assets/img/clients/creative_photo.png')}}" alt="">
        </div>
      </div>
      <div class="col-sm-6 col-lg-3 py-3 wow zoomIn">
        <div class="img-place client-img">
          <img src="{{asset('plantillas/template1/assets/img/clients/global_tv.png')}}" alt="">
        </div>
      </div>
    </div>
  </div>
...
<div class="position-realive bg-image" style="background-image: url({{asset('plantillas/template1/assets/img/pattern_1.svg')}});">
    ...
    <div class="row">
      <div class="col-lg-5 py-3">
        <div class="img-place mobile-preview shadow wow zoomIn">
          <img src="{{asset('plantillas/template1/assets/img/app_preview_2.png')}}" alt="">
        </div>
      </div>
...
<div class="page-section">
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-5 py-3">
        <div class="img-place mobile-preview shadow wow zoomIn">
          <img src="{{asset('plantillas/template1/assets/img/app_preview_3.png')}}" alt="">
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="row justify-content-center mt-5">
      <div class="col-md-6 col-lg-3 py-3">
        <div class="card card-body border-0 bg-transparent text-center wow zoomIn">
          <div class="mb-3">
            <img src="{{asset('plantillas/template1/assets/img/icons/rocket.svg')}}" alt="">
          </div>
      ...
      <div class="col-md-6 col-lg-3 py-3">
        <div class="card card-body border-0 bg-transparent text-center wow zoomIn" data-wow-delay="200ms">
          <div class="mb-3">
            <img src="{{asset('plantillas/template1/assets/img/icons/testimony.svg')}}" alt="">
          </div>
      ...
      <div class="col-md-6 col-lg-3 py-3">
        <div class="card card-body border-0 bg-transparent text-center wow zoomIn" data-wow-delay="400ms">
          <div class="mb-3">
            <img src="{{asset('plantillas/template1/assets/img/icons/promotion.svg')}}" alt="">
          </div>
      ...
      <div class="col-md-6 col-lg-3 py-3">
        <div class="card card-body border-0 bg-transparent text-center wow zoomIn" data-wow-delay="600ms">
          <div class="mb-3">
            <img src="{{asset('plantillas/template1/assets/img/icons/coins.svg')}}" alt="">
          </div>
      ...
      <div class="col-md-6 col-lg-3 py-3">
        <div class="card card-body border-0 bg-transparent text-center wow zoomIn" data-wow-delay="800ms">
          <div class="mb-3">
            <img src="{{asset('plantillas/template1/assets/img/icons/support.svg')}}" alt="">
          </div>
      ...
      <div class="col-md-6 col-lg-3 py-3">
        <div class="card card-body border-0 bg-transparent text-center wow zoomIn" data-wow-delay="1000ms">
          <div class="mb-3">
            <img src="{{asset('plantillas/template1/assets/img/icons/laptop.svg')}}" alt="">
          </div>
...
<div class="page-section bg-image" style="background-image: url({{asset('plantillas/template1/assets/img/pattern_2.svg')}});">
  <div class="container">
...
<div class="page-section bg-image bg-image-overlay-dark" style="background-image: url({{asset('plantillas/template1/assets/img/bg_testimonials.jpg')}});">
    ...
    <div class="row">
      <div class="col-lg-7 py-3 mb-5 mb-lg-0">
        <div class="img-place w-lg-75 wow zoomIn">
          <img src="{{asset('plantillas/template1/assets/img/illustration_contact.svg')}}" alt="">
        </div>
      </div>
      <div class="col-lg-5 py-3">
