      ...
      <ul class="navbar-nav ml-auto mt-3 mt-lg-0">
        <li class="nav-item dropdown active">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <a class="dropdown-item active" href="index">Homepage 2</a>
          </div>
        </li>
        <li class="nav-item">
...
<div class="page-hero-section bg-image hero-home-2" style="background-image: url({{asset('plantillas/template1/assets/img/bg_hero_2.svg')}});">
      ...
      <div class="row align-items-center h-100">
        ...
        <div class="col-lg-6 d-none d-lg-block wow zoomIn">
          <div class="img-place mobile-preview shadow floating-animate">
            <img src="{{asset('plantillas/template1/assets/img/app_showcase.svg')}}" alt="">
          </div>          
        </div>
      </div>
    </div>
      ...
      <div class="col-lg-10">
        <div class="row justify-content-center">
          <div class="col-md-6 col-lg-4 py-3 wow fadeInLeft">
            <div class="card card-body border-0 text-center shadow pt-5">
              <div class="svg-icon mx-auto mb-4">
                <img src="{{asset('plantillas/template1/assets/img/icons/payment.png')}}" alt="">
              </div>
          ...
          <div class="col-md-6 col-lg-4 py-3 wow fadeInUp">
            <div class="card card-body border-0 text-center shadow pt-5">
              <div class="svg-icon mx-auto mb-4">
                <img src="{{asset('plantillas/template1/assets/img/icons/customizable.png')}}" alt="">
              </div>
          ...
          <div class="col-md-6 col-lg-4 py-3 wow fadeInRight">
            <div class="card card-body border-0 text-center shadow pt-5">
              <div class="svg-icon mx-auto mb-4">
                <img src="{{asset('plantillas/template1/assets/img/icons/concept.png')}}" alt="">
              </div>
  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-7 wow fadeIn">
        <div class="img-place">
          <img src="{{asset('plantillas/template1/assets/img/app_preview_4.png')}}" alt="">
        </div>
      </div>
  ...
  <div class="container-fluid">
    <div class="owl-carousel stack-carousel mt-5 wow fadeInUp">
      <div class="item">
        ...
        <div class="avatar mt-3">
          <div class="avatar-img">
            <img src="{{asset('plantillas/template1/assets/img/person/person_1.png')}}" alt="">
          </div>
      ...
      <div class="item">
        ...
        <div class="avatar mt-3">
          <div class="avatar-img">
            <img src="{{asset('plantillas/template1/assets/img/person/person_2.png')}}" alt="">
          </div>
          <div class="avatar-caption">
            <p class="mb-0 fw-medium fg-primary">Galih Raugana</p>
      ...
      <div class="item">
        ...
        <div class="avatar mt-3">
          <div class="avatar-img">
            <img src="{{asset('plantillas/template1/assets/img/person/person_3.png')}}" alt="">
          </div>
          <div class="avatar-caption">
            <p class="mb-0 fw-medium fg-primary">Galih Raugana</p>
...
<div class="page-section">
  <div class="container">
    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-5 justify-content-center align-items-center mt-5">
      ...
      <div class="p-3 wow zoomIn">
        <div class="img-place client-img">
          <img src="{{asset('plantillas/template1/assets/img/clients/net_sport_tv.png')}}" alt="">
        </div>
      </div>
      <div class="p-3 wow zoomIn">
        <div class="img-place client-img">
          <img src="{{asset('plantillas/template1/assets/img/clients/news_digital_tv.png')}}" alt="">
        </div>
      </div>
      <div class="p-3 wow zoomIn">
        <div class="img-place client-img">
          <img src="{{asset('plantillas/template1/assets/img/clients/spa_beauty.png')}}" alt="">
        </div>
      </div>
      <div class="p-3 wow zoomIn">
        <div class="img-place client-img">
          <img src="{{asset('plantillas/template1/assets/img/clients/trivier_group.png')}}" alt="">
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="row justify-content-center text-center wow fadeInUp">
      <div class="col-lg-8">
        <div class="text-center mb-3">
          <img src="{{asset('plantillas/template1/assets/favicon-light.png')}}" alt="" height="80">
        </div>
