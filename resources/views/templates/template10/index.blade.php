...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<meta name="twitter:card" content="" />
  	...
  	<link rel="shortcut icon" href="{{asset('plantillas/template10/favicon.ico')}}">

  	<!-- Google Webfont -->
	<!-- <link href='http://fonts.googleapis.com/css?family=Roboto:300,400,700' rel='stylesheet' type='text/css'> -->
	<!-- Themify Icons -->
	<link rel="stylesheet" href="{{asset('plantillas/template10/css/themify-icons.css')}}">
	<!-- Bootstrap -->
	<link rel="stylesheet" href="{{asset('plantillas/template10/css/bootstrap.css')}}">
	<!-- Owl Carousel -->
	<link rel="stylesheet" href="{{asset('plantillas/template10/css/owl.carousel.min.css')}}">
	<link rel="stylesheet" href="{{asset('plantillas/template10/css/owl.theme.default.min.css')}}">
	<!-- Magnific Popup -->
	<link rel="stylesheet" href="{{asset('plantillas/template10/css/magnific-popup.css')}}">
	<!-- Superfish -->
	<link rel="stylesheet" href="{{asset('plantillas/template10/css/superfish.css')}}">
	<!-- Easy Responsive Tabs -->
	<link rel="stylesheet" href="{{asset('plantillas/template10/css/easy-responsive-tabs.css')}}">
	<!-- Animate.css -->
	<link rel="stylesheet" href="{{asset('plantillas/template10/css/animate.css')}}">
	<!-- Theme Style -->
	<link rel="stylesheet" href="{{asset('plantillas/template10/css/style.css')}}">

	<!-- Modernizr JS -->
	<script src="{{asset('plantillas/template10/js/modernizr-2.6.2.min.js')}}"></script>
	<!-- FOR IE9 below -->
	<!--[if lt IE 9]>
	...
	<body>
		...
		<header id="fh5co-header-section" role="header" class="" >
			<div class="container">
				...
				<!-- <div id="fh5co-menu-logo"> -->
					<!-- START #fh5co-logo -->
					<h1 id="fh5co-logo" class="pull-left"><a href="index.html"><img src="{{asset('plantillas/template10/images/logo.png')}}" alt="Valet Free HTML5 Template"></a></h1>
		...
		<div id="fh5co-hero" style="background-image: url({{asset('plantillas/template10/images/slide_2.jpg')}});">
		...
		<div id="fh5co-main">
					...
					<div class="row">
						<div class="col-lg-3 col-md-6 col-sm-6 animate-box">
							<a class="fh5co-card" href="#">
								<img src="{{asset('plantillas/template10/images/img_large_1.jpg')}}" alt="Free HTML5 Bootstrap template" class="img-responsive">
						...
						<div class="col-lg-3 col-md-6 col-sm-6 animate-box">
							<a class="fh5co-card" href="#">
								<img src="{{asset('plantillas/template10/images/img_large_2.jpg')}}" alt="Free HTML5 Bootstrap template" class="img-responsive">
								<div class="fh5co-card-body">
						...
						<div class="col-lg-3 col-md-6 col-sm-6 animate-box">
							<a class="fh5co-card" href="#">
								<img src="{{asset('plantillas/template10/images/img_large_3.jpg')}}" alt="Free HTML5 Bootstrap template" class="img-responsive">
								<div class="fh5co-card-body">
									<h3>Web Analyst</h3>
									<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste sunt porro delectus cum officia magnam.</p>
								</div>
			...
			<div class="animate-box fh5co-product-2">
				<div class="fh5co-half img" style="background-image: url({{asset('plantillas/template10/images/img_large_6.jpg')}});">
		...
		<!-- jQuery -->
		<script src="{{asset('plantillas/template10/js/jquery-1.10.2.min.js')}}"></script>
		<!-- jQuery Easing -->
		<script src="{{asset('plantillas/template10/js/jquery.easing.1.3.js')}}"></script>
		<!-- Bootstrap -->
		<script src="{{asset('plantillas/template10/js/bootstrap.js')}}"></script>
		<!-- Owl carousel -->
		<script src="{{asset('plantillas/template10/js/owl.carousel.min.js')}}"></script>
		<!-- Magnific Popup -->
		<script src="{{asset('plantillas/template10/js/jquery.magnific-popup.min.js')}}"></script>
		<!-- Superfish -->
		<script src="{{asset('plantillas/template10/js/hoverIntent.js')}}"></script>
		<script src="{{asset('plantillas/template10/js/superfish.js')}}"></script>
		<!-- Easy Responsive Tabs -->
		<script src="{{asset('plantillas/template10/js/easyResponsiveTabs.js')}}"></script>
		<!-- FastClick for Mobile/Tablets -->
		<script src="{{asset('plantillas/template10/js/fastclick.js')}}"></script>
		<!-- Waypoints -->
		<script src="{{asset('plantillas/template10/js/jquery.waypoints.min.js')}}"></script>
		<!-- Main JS -->
		<script src="{{asset('plantillas/template10/js/main.js')}}"></script>
